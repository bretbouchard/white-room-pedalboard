...
//==============================================================================
/**
 * Single mode in modal resonator
 *
 * Each mode represents a vibrational mode of the object:
 * - Frequency (pitch)
 * - Amplitude (energy)
 * - Decay (damping)
...
struct ModalResonatorMode
{
    ...
    float Q = 5.0f;                 // Resonance Q factor
...
public:
    ...
    struct Parameters
    {
        ...
        float structure = 0.5f;            // Harmonic structure (0 = harmonic, 1 = inharmonic)
    };
...
private:
    ...
    struct Parameters
    {
        ...
        float structure = 0.5f;        // Harmonic structure
