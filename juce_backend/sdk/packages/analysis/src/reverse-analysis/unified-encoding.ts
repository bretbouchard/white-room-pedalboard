...
import { GeneratorPair } from '@schillinger-sdk/shared/math/generators';
import {
  encodePattern as encodeRhythmPattern,
  type PatternEncoding as RhythmEncoding,
} from './rhythm-reverse';
import type { RhythmPattern } from './rhythm-reverse';
import { encodeMelody, type MelodicEncoding } from './melody-reverse';
import type { MelodyPattern } from './melody-reverse';
import { encodeProgression, type HarmonicEncoding } from './harmony-reverse';
import type { ChordProgression as ChordPattern } from '@schillinger-sdk/shared';
