...
describe('Additional Validation Tests', () => {
  describe('Contour Expansion Validation', () => {
    it('should preserve contour direction relationships for various inputs', () => {
      const testContours = [
        ['up', 'down', 'up'],
        ['up', 'up', 'down', 'same'],
        ['same', 'same', 'same'],
    ...
    it('should handle permutation operations correctly', () => {
      const contour = ['up', 'down', 'same', 'up'];
      const expansions = ExpansionOperators.expandContour(contour);
  ...
  describe('Interval Expansion Validation', () => {
    it('should maintain mathematical relationships in interval expansions', () => {
      const testIntervals = [
        [1, 2, 3],
        [2, 3, 5, 7],
        [1, 4, 6, 8, 12],
      ...
      testIntervals.forEach(intervals => {
        const expansions = ExpansionOperators.expandIntervals(intervals);
    ...
    it('should generate valid Fibonacci expansions', () => {
  ...
  describe('Transformation Validation', () => {
    it('should compose transformations associatively', () => {
      const data = [1, 2, 3, 4];
      const ratio1 = 2, ratio2 = 1.5;
  ...
  describe('Quality Metrics Validation', () => {
    it('should provide consistent quality scores', async () => {
      ...
      const expanded = [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5];
      ...
      expect(result.metrics.redundancy).toBe.lessThanOrEqual(1);
    });
  });
});