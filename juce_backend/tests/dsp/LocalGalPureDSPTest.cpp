/*
  ==============================================================================
    ...
    Unit tests for LocalGal Pure DSP implementation

    Tests the factory-created LocalGal instance to verify
...
//==============================================================================
// TEST SUITE: LocalGal Pure DSP
//==============================================================================

TEST(LocalGalFactoryCreation)
{
    DSP::InstrumentDSP* synth = DSP::createInstrument("LocalGal");
    ...
    if (name != "LocalGal") {
        throw std::runtime_error("Expected instrument name 'LocalGal' but got '" + name + "'");
    }
    if (version != "1.0.0") {
...
TEST(LocalGalParameters)
{
    ...
    synth->setParameter("feel_bite", 0.8f);
    float biteValue = synth->getParameter("feel_bite");
    EXPECT_NEAR(0.8f, biteValue, 0.01f);

    delete synth;
}

TEST(LocalGalPresetSaveLoad)
{
    DSP::InstrumentDSP* synth = DSP::createInstrument("LocalGal");
    EXPECT_NOT_NULL(synth);
    ...
    synth->setParameter("feel_bite", 0.85f);
    ...
    DSP::InstrumentDSP* synth2 = DSP::createInstrument("LocalGal");
...
TEST(LocalGalDeterminism)
{
    DSP::InstrumentDSP* synth1 = DSP::createInstrument("LocalGal");
    DSP::InstrumentDSP* synth2 = DSP::createInstrument("LocalGal");
...
int main()
{
    std::cout << "\n";
    std::cout << "===========================================\n";
    std::cout << "LocalGal Pure DSP Tests\n";
    std::cout << "===========================================\n\n";

    // Test 1: Factory Creation
    std::cout << "Running test 1: LocalGalFactoryCreation...\n";
    try {
        Test::test_LocalGalFactoryCreation();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    ...
    // Test 2: Prepare
    std::cout << "\nRunning test 2: LocalGalPrepare...\n";
    try {
        Test::test_LocalGalPrepare();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 3: Reset
    std::cout << "\nRunning test 3: LocalGalReset...\n";
    try {
        Test::test_LocalGalReset();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 4: Note On/Off
    std::cout << "\nRunning test 4: LocalGalNoteOnOff...\n";
    try {
        Test::test_LocalGalNoteOnOff();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 5: Process
    std::cout << "\nRunning test 5: LocalGalProcess...\n";
    try {
        Test::test_LocalGalProcess();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 6: Parameters
    std::cout << "\nRunning test 6: LocalGalParameters...\n";
    try {
        Test::test_LocalGalParameters();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    std::cout << "\nRunning test 7: LocalGalPresetSaveLoad...\n";
    try {
        Test::test_LocalGalPresetSaveLoad();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 8: Polyphony
    std::cout << "\nRunning test 8: LocalGalPolyphony...\n";
    try {
        Test::test_LocalGalPolyphony();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
    ...
    // Test 9: Determinism
    std::cout << "\nRunning test 9: LocalGalDeterminism...\n";
    try {
        Test::test_LocalGalDeterminism();
        Test::testsPassed++;
        std::cout << "PASSED\n";
    } catch (const std::exception& e) {
        Test::testsFailed++;
