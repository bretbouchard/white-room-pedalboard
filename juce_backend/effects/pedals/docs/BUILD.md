...
### macOS
VST3: `cp -R build/VST/*.vst3 ~/Library/Audio/Plug-Ins/VST3/`
AU: `cp -R build/AU/*.component ~/Library/Audio/Plug-Ins/Components/`
Standalone: `cp build/Standalone/* /Applications/`
