...
export default defineWorkspace([
  ...
  },
  {
    ...
    resolve: {
      alias: {
        'shared': resolve(__dirname, './sdk/packages/shared/src'),
        'core': resolve(__dirname, './sdk/packages/core/src'),
        'gateway': resolve(__dirname, './sdk/packages/gateway/src'),
        'analysis': resolve(__dirname, './sdk/packages/analysis/src'),
        'audio': resolve(__dirname, './sdk/packages/audio/src'),
        'admin': resolve(__dirname, './sdk/packages/admin/src'),
        'generation': resolve(__dirname, './sdk/packages/generation/src'),
      },
    },
  },
  {
