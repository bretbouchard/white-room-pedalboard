# Schillinger SDK v2.1 API Documentation

## Overview

The Schillinger SDK v2.1 introduces revolutionary new APIs for the Moving Sidewalk Realization System alongside enhanced Generator APIs. All existing v1.x APIs remain fully compatible.
...
```bash
npm install @schillinger-sdk/core@2.1.0
npm install @schillinger-sdk/shared@2.1.0
```
