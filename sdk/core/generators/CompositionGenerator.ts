...
> {
   ...
   */
  async create(
    params: CompositionCreationParams,
  ): Promise<GeneratorResult<Composition>> {
  ...
  > {
    ...
    try {
      ...
      const arrangement = await sdk.composition.generateArrangement(
        composition,
        params,
      );
      ...
      throw new Error(
        `CompositionGenerator.generateArrangement failed: ${error}`,
      );
    }
  }
  ...
  async analyzeComposition(
  ...
  ): Promise<GeneratorResult<CompositionAnalysis>> {
    ...
    try {
      ...
      throw new Error(
        `CompositionGenerator.analyzeComposition failed: ${error}`,
      );
    }
  }
   ...
   */
  async encodeUserInput(params: UserInputParams): Promise<
    GeneratorResult<{
      rhythmParams: any;
      harmonyParams: any;
      melodyParams: any;
  ...
  generateSection(
    ...
    try {
      ...
      const section: Section = {
        ...
        position: context.previousSection
          ? context.previousSection.position + context.previousSection.length
          : 0,
        rhythm: {
